...
play_wordle <- function(solution, valid_list, num_guesses=6){
 ...
 # read in guess
    ...
    #lettersLeft<-setdiff(lettersLeft, guessVec) #this removes all letters used in a guess
   #lettersLeft<-setdiff(lettersLeft, setdiff(guessVec, solution)) # this doesn't remove anything
    
    notsolution<- setdiff(guessVec, solution)
    lettersLeft<-setdiff(lettersLeft, notsolution)
    
    ##AK:I think this is the issue, because it now displays the alpahbet - ALL the letters in the guess, instead of only the Guess-solution letters. I tried to do that with this code, but it sill just eliminates all the letters in the guess...maybe I'm not understaingsing setdiff correctly....
